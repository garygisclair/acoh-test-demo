...
var SheetImplementationCustom = React79.forwardRef(function(props, forwardedRef) {
  ...
  }, []), getAnimatedNumberStyle = React79.useCallback((val) => {
    "worklet";
    return {
      transform: [{
  ...
  }, [frameSize]), animatedStyle = useAnimatedNumberStyle(animatedNumber, getAnimatedNumberStyle), [opacity, setOpacity] = React79.useState(open2 ? 1 : 0);
